                        ...
                        <div className="text">
                            <div className="column mb-5"  >
                                <p className="question">
                                    ...
                                    <span>
                                        Contact{" "}
                                        <a
                                            href="mailto:info@Beauty Zone-lb.com"
                                            data-auto-id="true"
                                            id="page-footer-mailto-support-bellroy-com-1"
                                        >
                                            info@Beauty Zone-lb.com
                                        </a>
                                    </span>
                                </p>
                            </div>
                            <div className="column">
                                <span className="copyright">
                                    All rights reserved © {(new Date().getFullYear())} Beauty Zone
                                </span>
                            </div>
                        </div>
                    </div>
